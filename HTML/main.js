...
var ProductItemListComponent = /** @class */ (function () {
    function ProductItemListComponent(http) {
        ...
        this.http.get('/products')
            ...
            _this.groups = lodash__WEBPACK_IMPORTED_MODULE_2__["toPairs"](lodash__WEBPACK_IMPORTED_MODULE_2__["reduce"](lodash__WEBPACK_IMPORTED_MODULE_2__["compact"](lodash__WEBPACK_IMPORTED_MODULE_2__["uniqBy"](lodash__WEBPACK_IMPORTED_MODULE_2__["flatten"](lodash__WEBPACK_IMPORTED_MODULE_2__["map"](data, function (x) { return x.tag; })), 'name')), function (recorder, cat) {
                recorder[cat.name] = lodash__WEBPACK_IMPORTED_MODULE_2__["filter"](data, function (item) {
                    return item.tag && item.tag.includes(cat);
                });
                return recorder;
            }, {
                'Uncategory': lodash__WEBPACK_IMPORTED_MODULE_2__["filter"](data, function (x) { return !x.tag || !x.tag.length; })
            }));
        });
    }
